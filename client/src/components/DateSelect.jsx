  ...
  return (
    <div id="dateSelect" className="pt-30">
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative p-8 bg-primary/10 border border-primary/20 rounded-lg">
        ...
        <button onClick={onBookHandler} className="cursor-pointer py-2 px-6 rounded-md bg-primary text-white hover:bg-primary-dull transition active:scale-95">Book Now</button>
      </div>
    </div>
  );
}
